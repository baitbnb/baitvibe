  ...
  return (
    <section id="threads" className="py-24 px-[6vw] relative z-10">
      ...
      <p className="text-muted-foreground text-base max-w-[480px] leading-relaxed">
        Turn one idea into a perfectly structured Twitter thread. YiClaw AI writes hooks, insights, and CTAs that drive engagement.
      </p>
      ...
      <div className="mt-16 max-w-[640px] mx-auto">
        ...
        <div className="flex gap-3 mt-2">
          <button className="flex-1 py-3 bg-gradient-to-br from-gold to-[hsl(32,85%,48%)] rounded-lg text-primary-foreground font-bold text-sm shadow-[0_0_20px_hsl(var(--gold)/0.3)]">
            📋 Copy All Tweets
          </button>
